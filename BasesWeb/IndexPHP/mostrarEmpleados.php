...
<body>
        ...
        <div class="card"><br>
            ...
            //consulta sencilla
            $query = 'select * from empleadosEmpresa';
            $result = pg_query($query) or die('Query failed: ' . pg_last_error());
            $rows = pg_numrows($result);

            //impresion primaria
            echo "<h1 align='center' class='titulo-label'>Empelados de Empresa</h1><br>";
            echo "<table border =1 align='center'>\n";
            echo "<tr align='center'><td>CEDULA<td>NOMBRE<td>GENERO<td>FECHA NACIMIENTO<td>POLIZA<td>CUENTA BANCARIA<td>SALARIO<td>ESTADO CIVIL<td>NACIONALIDAD<td></tr>";
            ...
            for($i=1;$i<=$rows; $i++){
                ...
                echo "\t\t<td>$line[fechanacimiento]</td>\n";
                echo "\t\t<td>$line[poliza]</td>\n";
                echo "\t\t<td>$line[cuentabancaria]</td>\n";
                echo "\t\t<td>$line[salario]</td>\n";
                echo "\t\t<td>$line[estadocivil]</td>\n";
                echo "\t\t<td>$line[nacionalidad]</td>\n";
                echo "\t</tr>\n";
            }
            echo "</table>\n";
            echo "<hr>";

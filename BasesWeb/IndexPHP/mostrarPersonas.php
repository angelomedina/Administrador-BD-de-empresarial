...
<div class="NavBar">
    ...
    <div class="card"><br>
        ...
        //impresion primaria
        echo "<h1 align='center' class='titulo-label'>Clientes Empresa</h1><br>";
        echo "<table border =1 align='center'>\n";
        echo "<tr align='center'><td>CEDULA<td>NOMBRE<td>APELLIDOI<td>APELIIDOII<td>GENERO<td>FECHA NACIMIENTO</tr>";
        ...
        for($i=1;$i<=$rows; $i++){
            ...
            echo "\t\t<td>$line[primerapellido]</td>\n";
            echo "\t\t<td>$line[segundoapellido]</td>\n";
